...
public class AutonomousMode 
{
    ...
    static void usage()
    {
        System.out.printf("Usage: Please provide valid arguments, such as:\n"
                + "AutonomousMode [-v] [reader-uri] [--ant n[,n...]] --enable/disable \n" +
                  "-v  Verbose: Turn on transport listener\n" +
                  "reader-uri  Reader URI: e.g., \"tmr:///COM1\", \"tmr://astra-2100d3\"\n"
                + "--ant  Antenna List: e.g., \"--ant 1\", \"--ant 1,2\"\n" +
                  "--enable/disable: Enable/Disable autonomous mode on the reader\n"
                + "e.g: tmr:///com1 --ant 1,2 --enable; tmr://10.11.115.32 --ant 1,2 --disable\n ");
        System.exit(1);
    }
