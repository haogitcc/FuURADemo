...
public class AndroidUsbReflection 
{
    ...
    {   
        return (Integer)invokeMethod(getMethod(ftDev.getClass(), "read", new Class[]{byte[].class, int.class, long.class}),
                                     ftDev, buf, Integer.valueOf(len), Long.valueOf(timeout));
    }
    
    public static int read(byte[] buf, int len) throws IOException
    {   
        return (Integer)invokeMethod(getMethod(ftDev.getClass(), "read", new Class[]{byte[].class, int.class}),
                                     ftDev, buf, Integer.valueOf(len));
    }
    
    public static int read(byte[] buf) throws IOException
    {   
        return (Integer)invokeMethod(getMethod(ftDev.getClass(), "read", new Class[]{byte[].class}),
                                     ftDev, buf);
    }
