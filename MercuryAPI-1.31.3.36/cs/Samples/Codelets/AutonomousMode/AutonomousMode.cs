    ...
    class AutonomousMode
    {
        static void Usage()
        {
            Console.WriteLine(String.Join("\r\n", new string[] {
                    " Usage: "+"Please provide valid reader URL, such as: [-v] [reader-uri] [--ant n[,n...]] [option]",
                    " -v : (Verbose)Turn on transport listener",
                    " reader-uri : e.g., 'tmr:///com4' or 'tmr:///dev/ttyS0/' or 'tmr://readerIP'",
                    " [--ant n[,n...]] : e.g., '--ant 1,2,..,n",
                    " [--option] : e.g, '--enable/disable'",
                    " Example: 'tmr:///com4 --enable/disable' or 'tmr:///com4 --ant 1,2 --enable/disable' or '-v tmr:///com4 --ant 1,2 --enable/disable'"
            }));
            Environment.Exit(1);
        }
        static void Main(string[] args)
        {
            ...
            if (-1 == Array.IndexOf(args, "--enable") && -1 == Array.IndexOf(args, "--disable"))
            {
                Usage();
            }
            ...
            try
            {
                ...
                using (Reader r = Reader.Create(args[0]))
                {
                        ...
                        "M6e Nano".Equals(model) || "M6e Micro USB".Equals(model)|| "M6e Micro USBPro".Equals(model))
                    {
                        ...
                        if (!Convert.ToBoolean(AutonomousMode)) // Disable the Autonomous Read
                        {
                        ...
                        else //To Enable the Autonomous Read
                        {
