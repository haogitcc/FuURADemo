                    ...
                    foreach (string line in lines)
                    {
                        ...
                        else if (line.Contains("/application/readwriteOption/Antennas"))
                        {
                            ...
                            foreach (string r in antennaArray)
                            {
                                ...
                                {
                                    if (!DetectedReaderModel.Equals("M6e Nano"))
                                    {
                                        builder.Append(2);
                                        builder.Append(',');
                                    }
                                ...
                                {
                                    if (!(DetectedReaderModel.Equals("M6e Nano") || DetectedReaderModel.Equals("M6e Micro") || DetectedReaderModel.Equals("M6e Micro USB") || DetectedReaderModel.Equals("M6e Micro USBPro")))
                                    {
                                        builder.Append(3);
                                        builder.Append(',');
                                    }
