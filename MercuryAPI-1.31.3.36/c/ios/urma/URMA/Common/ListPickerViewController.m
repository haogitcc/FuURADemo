...
- (void)viewDidLoad
{
    ...
    if ([listType isEqualToString:@"BaudRate"]) {
        ...
        for (int i=0; i<[tempArry count]; i++) {
            ...
            else if([[tempArry objectAtIndex:i] intValue] == 13){
                [dataArray addObject:@"NA_NARROW"];
            }
