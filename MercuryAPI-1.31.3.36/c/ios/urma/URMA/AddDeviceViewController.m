...
- (IBAction)connectAction:(id)sender {
    ...
    if (TMR_SUCCESS != ret)
    {
        NSLog(@"Create Status:%s", TMR_strerr(rp, ret));
    }
    
    NSLog(@"Device URL ----- %s", deviceURI);
    ...
    dispatch_async( dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
        ...
        dispatch_async( dispatch_get_main_queue(), ^{
            ...
            if (TMR_SUCCESS == ret)
            {
                ...
                headerView.statusShowIcon.image=[UIImage imageNamed:@"light-green.png"];
                ...
                else
                {
                    ...
                    dispatch_async( dispatch_get_main_queue(), ^{
                        ...
                        if (readToggle) {
                            ...
                            [keyWindow.rootViewController presentViewController:readResultsViewController animated:NO completion:nil];
...
-(void) stopReadResults{
    ...
    NSLog(@"**** STOp Action in Add Device *******");
