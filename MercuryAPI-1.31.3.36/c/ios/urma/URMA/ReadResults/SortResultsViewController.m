...
- (void)viewDidLoad {
    ...
    {
        self.selSortBy = savedSortByString;
        self.selSortByIndex = [NSNumber numberWithInt:[savedSortByIndexString intValue]];
    ...
    {
        self.selSortBy = [self.sortByArray objectAtIndex:1];
         self.selSortByIndex = [NSNumber numberWithInt:1];
        self.checkedIndexPathSection0 = [NSIndexPath indexPathForRow:1 inSection:0];
    }
    
    if([savedSortOrderString length] > 0)
    {
        self.selSortOrder = savedSortOrderString;
    ...
    {
        self.selSortOrder = [self.sortOrderArray objectAtIndex:0];
...
-(IBAction)applyButton:(UIButton *)sender
{
    ...
    NSLog(@"Sort results By -- %@ By Order -- %@", [self getObjectString:self.selSortBy],self.selSortOrder);
