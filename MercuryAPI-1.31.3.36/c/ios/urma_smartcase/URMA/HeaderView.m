...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (IS_IPAD) {
        self.frame = CGRectMake(0, 0, 768, 44);
    } else {
    ...
    logoview.frame = CGRectMake(-5.0, 0.0, 150.0, 44.0);
    logoview.image=[UIImage imageNamed:@"thingmagic_title_logo.png"];
    [self addSubview:logoview];
    
    ttllbl = [[UILabel alloc] init];
    if (IS_IPAD) {
        ttllbl.frame = CGRectMake(250.0, 0.0, 250.0, 44.0);
    ...
    if (IS_IPAD) {
        statusShowIcon.frame = CGRectMake(610,5,32,32);
    } else {
        statusShowIcon.frame = CGRectMake(190,5,29,29);
    }
    ...
    offBtn.tag = 0;
    if (IS_IPAD) {
        offBtn.frame = CGRectMake(665.0, 4.0, 33, 33);
    } else {
        offBtn.frame = CGRectMake(235.0, 4.0, 30, 30);
    }
    ...
    if (orientation == UIInterfaceOrientationLandscapeLeft || orientation == UIInterfaceOrientationLandscapeRight) {
        ...
        if (IS_IPAD) {
            ...
            self.logoview.frame = CGRectMake(0.0, 0.0, 150.0, 44.0);
            self.ttllbl.frame = CGRectMake(380.0, 0.0, 250.0, 44.0);
            self.statusShowIcon.frame = CGRectMake(865,5,32,32);
            self.offBtn.frame = CGRectMake(920.0, 4.0, 33, 33);
            self.settingBtn.frame = CGRectMake(970.0, 6.0, 32.0, 32.0);
        }
    }
