//
//  SerialSmartCaseDeviceViewController.h
//  URMA
//
...
extern int selectedIndex_s1;

@interface SerialSmartCaseDeviceViewController : UIViewController<UITextFieldDelegate,ListPickerViewControllerDelegate>{
